...
parser.add_argument('--atom', type=int, default=51, metavar='SIZE', help='Discretized size of value distribution')    # parser.add_argument('--atoms', type=int, default=51, metavar='C', help='Discretised size of value distribution')
...
parser.add_argument('--log-interval', type=int, default=25000, metavar='STEPS', help='Training steps between logging status')
